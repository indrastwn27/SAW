...
<div class="card shadow mb-5">
    ...
    <div class="card-body">
        ...
        <div>
            <p style="color: black; font-weight: bold">Tabel Berikut Ini Menampilkan Nama - Nama Jurusan Yang Akan Dievaluasi.</p>
        <div>
          ...
          <table class="table table-bordered">
              <thead>
                 <tr>
                    ...
                    <th scope="col" style="color: black">Nama Jurusan</th>
